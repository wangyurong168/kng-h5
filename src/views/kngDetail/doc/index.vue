<template>
  <div class="over-hidden" :class="isAddStudy ? 'pb54' : null" v-if="loading">
    <play-area ref="playarea" :kngInfo="kngInfo" @getDetal="getKngDetail" kngType="doc" :kngConf="kngConf" :isShowProgress="isShowProgress" @changeShedule="changeShedule"></play-area>
...
export default {
  ...
  methods: {
    ...
    getIsAdd (val) {
      ...
      if (this.$refs.docViewer) {
        this.$refs.docViewer.showTip()
      }
    },
    // 获取知识详情
    getKngDetail () {
