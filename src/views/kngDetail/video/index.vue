<template>
  <div class="over-hidden" :class="isAddStudy ? 'pb54' : null" v-if="loading">
    <play-area :kngInfo="kngInfo" kngType="video" @getDetal="getKngDetail" ref="playarea" :kngConf="kngConf" :isShowProgress="isShowProgress" @changeShedule="changeShedule"></play-area>
